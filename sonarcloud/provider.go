	...
	sonarcloudProvider = &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"sonarcloud_qualitygate_project_association":    resourceSonarcloudQualityGateProjectAssociation(),
                        "sonarcloud_qualityprofile_change_parent":       resourceSonarcloudQualityProfileChangeParent(),
                        "sonarcloud_qualityprofile_project_association": resourceSonarcloudQualityProfileProjectAssociation(),
                        "sonarcloud_qualityprofile_set_default":         resourceSonarcloudQualityProfileDefault(),
